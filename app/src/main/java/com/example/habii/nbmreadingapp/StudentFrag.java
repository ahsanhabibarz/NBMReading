 ...
 * {@link StudentFrag.OnFragmentInteractionListener} interface
...
public class StudentFrag extends Fragment {
    ...
    TeachersStudentsAdapter teachersStudentsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        teachersStudentsAdapter = new TeachersStudentsAdapter(teachersModelClassList,container.getContext(),getActivity());

        mAuth = FirebaseAuth.getInstance();


        Query fireQuery = firebaseFirestore.collection("Teachers").document(mAuth.getCurrentUser().getUid()).collection("Class")
                .document(post_id).collection("Students").orderBy("name",Query.Direction.ASCENDING);
            ...
            public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                ...
                for(DocumentChange documentChange : documentSnapshots.getDocumentChanges()){
                    ...
                    if(documentChange.getType() == DocumentChange.Type.ADDED ){
                        ...
                        teachersStudentsAdapter.notifyDataSetChanged();
                        ...
                        teachersStudentsAdapter.notifyItemRemoved(documentChange.getOldIndex());
        ...
        recyclerView.setAdapter(teachersStudentsAdapter);
